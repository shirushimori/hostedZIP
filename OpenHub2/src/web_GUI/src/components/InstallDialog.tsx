    ...
    <div className="id-overlay">
      <div className="id-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="id-body">
          ...
          <label className="id-field">
            <span>Archive Password {passwordError ? <span className="id-pw-error">(wrong password!)</span> : '(default: 1)'}</span>
            <div className="id-input-row">
              <input
                type="password"
                value={password}
                onChange={e => setPassword(e.target.value)}
                placeholder="Default password is 1"
                disabled={installing}
